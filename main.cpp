...
public:
  ...
  void test() {
    ...
    ListNode node0(0);
    ListNode node1(1, &node0);
    ListNode node2(2, &node1);
    ListNode node3(3, &node2);
    ListNode node4(4, &node3);
    ListNode* pHead = &node4;
    printListNode(pHead);
    reverseList(&node1);

    pHead = reverseList(&node4);
    //sln.printListNode(pHead);
    reverseList(nullptr);
    reverseList(&node1);
    
    cout << "test for MaxSubString" << endl;
    string strTest = "bbbb";
    cout << strTest << ": " << lengthOfLongestSubstring(strTest) << endl;
    strTest = "abcdabcd";
    cout << strTest << ": " << lengthOfLongestSubstring(strTest) << endl;
    strTest = "pwwkew";
    cout << strTest << ": " << lengthOfLongestSubstring(strTest) << endl;
